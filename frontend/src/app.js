...
//                 this.addMessage('System', `User ${data.userId} joined the session`, 'system');
//             });
//             
...
//                     <strong>Agent:</strong> ${session.agentId}
...
//         this.agentIdSpan.textContent = this.currentSession.agentId;
...
//     async loadMessages() {
//         try {
//             const response = await fetch(`http://localhost:3001/messages/${this.currentSession.id}`, {
//                 headers: {
//                     'Authorization': `Bearer ${this.token}`
//                 }
//             });
...
//         messageEl.classList.add(message.senderId === this.userId ? 'user' : 'agent');
//         
//         const time = new Date(message.timestamp).toLocaleTimeString();
//         messageEl.innerHTML = `
//             <div class="message-info">${message.senderId} at ${time}</div>
...
//         
//         try {
//             const response = await fetch(`http://localhost:3001/session/${targetSessionId}/end`, {
//                 method: 'POST',
//                 headers: {
//                     'Authorization': `Bearer ${this.token}`,
//                     'Content-Type': 'application/json'
